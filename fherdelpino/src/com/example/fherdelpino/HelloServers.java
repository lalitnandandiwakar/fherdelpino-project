...
public class HelloServers extends HttpServlet {
    ...
    private void handleOperations(HttpServletRequest req, HttpServletResponse res) throws IOException {
	...
	}
	{
		...
		for (Cookie c : req.getCookies()) {
		    writer.append(c.getName() + "(" + c.getDomain() + ": " + c.getPath() + ": " + c.getMaxAge() + "): "
			    + c.getValue() + "\n");
		}
	    }
	}
